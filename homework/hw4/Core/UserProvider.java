...
import homework.hw4.Interfaces.IUserRepo;
import homework.hw4.Models.User;
import homework.hw4.Services.UserRepository;
...
public class UserProvider {
    ...
    public IUserRepo getClientRepository() {
    ...
    /**
     * Метод получения списка всех клиентов (для реализации тестов и
     * администрирования), не используется.
     *
