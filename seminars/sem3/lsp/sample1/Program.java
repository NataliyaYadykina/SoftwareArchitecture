...
public class Program {
     ...
     * когда каждому объекту oS типа S
     * соответствует некий объект oT типа T таким образом, что
     * для всех программ P, реализованных в терминах T,
     * поведение P не будет меняться,
     * если oT заменить на oS.
     */
